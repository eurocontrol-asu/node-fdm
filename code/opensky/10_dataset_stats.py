...
for acft in TYPECODES:
    ...
    print(acft, 
          len(train_files), round(len(train_dataset) * 60 * 4 / 3600,2),
          len(validation_files), round(len(val_dataset) * 60 * 4 / 3600,2),
          len(test_files), round(len(test_dataset)* 60 * 4 / 3600,2),
        sep=" & ", end=" \\\\\n")
# %%
