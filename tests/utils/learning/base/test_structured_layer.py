...
def make_layer(input_cols, output_cols, input_mean=0.0, input_std=1.0, output_mean=0.0, output_std=1.0, output_max=5.0):
    input_mean_dict = {col: input_mean for col in input_cols}
    input_std_dict = {col: input_std for col in input_cols}
    output_mean_dict = {col: output_mean for col in output_cols}
    output_std_dict = {col: output_std for col in output_cols}
    output_max_dict = {col: output_max for col in output_cols}
