...
col_dist_to_thr = Column(
    "distance_to_thr", "dist_to_thr", "TRAJ__DIST_TO_THR", nautical_miles
)
...
col_mach = Column(
    "mach number", "mach", "SPD__MACH", dimensionless, normalize_mode=None
)
...
col_ff_right = Column(
    "fuel flow right", "ff_right", "FUEL__FF_RIGHT", kilogram_per_hour
)
...
col_vz_sel = Column(
    "selected vertical speed", "vz_sel", "SPD__VERT_SEL", feet_per_minute
)
...
col_cross_wind_spd = Column(
    "cross wind speed", "cross_wind_spd", "WIND__CROSS_WIND", knot
)
...
col_fma_2 = Column(
    "FMA column 2", "fma_col_2", "FMA_COL_2", fma_col_2, loss_name="cross_entropy"
)
...
col_reduce_engine = Column(
    "reduce engine", "reduce_eng", None, boolean, normalize_mode=None
)
