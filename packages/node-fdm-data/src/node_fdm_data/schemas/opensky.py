"""Column schemas and conversion registry for the OpenSky 2025 architecture.

Column names are plain strings.  The ``CONVERSIONS`` dictionary maps
raw column names to ``(conversion_fn, target_name)`` tuples, where
*conversion_fn* is a Polars expression factory from
:mod:`node_fdm_data.conversions`.
"""
