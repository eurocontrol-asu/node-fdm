...
- **Qualification evidence** — `load_qualification_evidence` verifies the SHA-256 digests of the bundled experiment-03 evidence before returning its Polars table, parsed grids and metrics, provenance, and package-local evidence directory
...
```python
from node_fdm_data import load_qualification_evidence
...
to inspect the frozen manifest and `verify_digests` to validate a copied evidence directory.
