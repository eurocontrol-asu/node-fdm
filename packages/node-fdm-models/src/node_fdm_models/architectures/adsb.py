...
from node_fdm_models.schemas.adsb import DX_COLS, E0_COLS, E1_COLS, U_COLS, X_COLS
...
NODE_ADSB_V1 = ArchitectureSpec(
    ...
    preprocessing_fn="node_fdm_models.preprocessing.opensky.flight_processing",
